        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="theme-card">
                    <form class="theme-form" action="<?php echo base_url('forgotpw/email'); ?>" method="post">
                        <div class="form-row">
                            <div class="col-md-6">
                                <label for="email">Enter Your Email</label>
                                <input type="email" class="form-control" name="email" id="fname"  placeholder="Enter your Email" required="">
                            </div>
							<div class="col-md-6">
							</div>
