...
<div class="container">
    ...
    <?php 
		...
		$uv = NULL;
		//echo $chekx;
		foreach($chekz as $c){ $uv = $c->u_c ;}
		foreach($chekz2 as $d){ $uc = $d->u_v ;}
		//echo $uv;
		//echo $uc;
		//echo $chekz['u_v'][0];
		//echo $chekz2['u_c'][0];
		...
		echo "<script>alert('user sudah digunakan');window.top.location.href='https://store.rencara.com/Regcust'; </script>"
		;} 
		else {
