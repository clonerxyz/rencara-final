...
<div class="limiter">
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100 p-l-110 p-r-110 p-t-62 p-b-33">
				...
				<form class="login100-form validate-form flex-sb flex-w" action="<?php echo base_url('Regcust/add'); ?>" method="post" enctype="multipart/form-data">
					<span class="login100-form-title p-b-53">
						<img style="width:50%;"src="https://store.rencara.com/ct/image/rcr2.png">
					</span>
					<div class="p-t-31 p-b-9"><span class="txt1">Username / Email</span></div>
					<div class="wrap-input100" data-validate = "Username is required">
					<input class="input100 form-control" id="name" placeholder="username" required type="text" name="u_c" onchange="checker()">
					...
					var y = "https://store.rencara.com/Regcust/readu/";
					iframe.setAttribute('src',"https://store.rencara.com/Regcust/readu/"+x.value);
					}
					</script>
					...
					<input class="input100 form-control" placeholder="password" type="password" required name="p_c" >
					<span class="focus-input100"></span>
					</div>
