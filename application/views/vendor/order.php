  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
          ...
          <div class="card-body">
            <div class="table-responsive">
              <table class="table table-sm" id="dataTable" width="100%" cellspacing="0">
				...
				?>
				<tr>
                    <td><?php echo $i->midtrans_id ?></td>
					<td><?php echo $i->quantity ?></td>
					<td><?php echo $i->name ?></td>
					<td><?php echo $i->customer ?></td>
                    <td><?php echo $i->payable ?></td>
					<!--<td>action</td>
					<td>
		...
		<ol class="breadcrumb mb-4">
            <li class="breadcrumb-item active">MY Order / Create process</li>
        </ol>
		<p>Order dapat di proses jika status sudah settelment di database kami</p>
		<form action="https://store.rencara.com/vendor/oprocess" method="POST">
			<div class="form-group">
			<label for="formGroupExampleInput">Order_id</label>
			<select id="formGroupExampleInput" name="order_id">
			<?php foreach ($resr as $t) { ?>
