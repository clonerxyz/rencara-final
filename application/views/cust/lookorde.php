...
<form method="post" action="https://store.rencara.com/cust/sentrep/<?php foreach($res as $r){ echo $r->ido; } ?>">
	...
	<textarea id="tiket" onclick="func()" class="form-control" style="widh:500px;height:300px" name="isi_tiket" required=""></textarea>
	</div>
...
window.onload=function(){
    if (check === "Re : <?php foreach($res as $n){ echo $n->subject; }?>"){
		$("#reply").hide();
		$("#showrep").show();
	}
