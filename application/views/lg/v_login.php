        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="theme-card">
                    <form class="theme-form" action="<?php echo base_url('login/aksi_login'); ?>" method="post">
                        <div class="form-group">
                            <label for="email">Username</label>
                            <input type="text" class="form-control" name="username" id="email" placeholder="Enter your username" required="">
							<input type="hidden" class="form-control" name="tempu" id="email" value="<?php echo $this->session->userdata("nama"); ?>" placeholder="Enter your username" required="">
                        </div>
                        <div class="form-group">
                            <label for="review">Password</label><a href="https://store.rencara.com/forgotpw" class="txt2 bo1 m-l-5">
							Forgot?
						</a>
            ...
            <div class="col-lg-6 right-login">
                ...
                <div class="theme-card authentication-right">
					...
					<a href="https://store.rencara.com/regcust" class="btn btn-solid">Become customer</a>
					<div class="">&nbsp;</div>
					<a href="https://store.rencara.com/regven" class="btn btn-solid">Become vendor &nbsp;&nbsp;&nbsp;&nbsp;</a>
					</div>
            </div>
        </div>
    </div>
