									...
									<div class="media">
                                        <div class="media-body">
                                            ...
                                            <div class="progress sm-progress-bar">
                                                <div class="progress-bar bg-dark" role="progressbar" style="width: <?php echo $citem4 ?>%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="media">
                                    ...
                                    <div class="tab-pane fade show active" id="top-profile" role="tabpanel" aria-labelledby="top-profile-tab">
                                        ...
                                        <div class="table-responsive profile-table">
                                            <table class="table table-responsive">
                                                ...
                                                <tr>
                                                    <td>First Name:</td>
                                                    <td><?php foreach ($info as $i){ echo $i->n_vendor; } ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Last Name:</td>
                                                    <td><?php foreach ($info as $i){ echo $i->u_v; } ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Email:</td>
                                                    <td><?php foreach ($info as $i){ echo $i->contact; } ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Mobile Number:</td>
                                                    <td><?php foreach ($info as $i){ echo $i->phone; } ?></td>
                                                </tr>
                                               
                                                <tr>
                                                    <td>Location:</td>
                                                    <td><?php foreach ($info as $i){ echo $i->alamat; } ?></td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        </div>
