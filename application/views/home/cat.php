...
<div class="title1 section-t-space">
     <h4></h4>
	 <h2 class="title-inner1">Category <?php $no = 1;foreach($res3 as $g){ ?><?php echo $g->n_cat?><?php } ?></h2>
</div>
                                    ...
                                    <div class="img-wrapper">
                                        ...
                                        <div style="width:250px; height:250px;background-color:white;"class="back">
                                            <form action="<?php echo base_url('hp/input'); ?>" method="post">
													...
													<p class="btn btn-warning">Quantity : </p> <input type="number" class="col-4 form-control-sm"value="1" name="quantity" min="1" max="20" required></br>
