				...
				<?php $no = 1;foreach($find as $e){ ?>
                    ...
                    <div class="product-box">
                        <div class="img-wrapper">
							...
							<div style="height:250px;width:250px;background-color:white;" class="back">
...
<div class="title1 section-t-space">
     <h4></h4>
	 <h2 class="title-inner1"><?php echo $key; ?></h2>
</div>
<section class="section-b-space p-t-0 ratio_asos">
    <div class="container">
        <div class="row">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
						...
						<a class="btn btn-solid text-center" href="https://store.rencara.com/cust/search/<?php echo $key ?>/<?php echo $lim ?>/<?php echo $pae ?>">load more</a>
                    </div>
