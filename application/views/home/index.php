...
<head>
	...
	<link rel="stylesheet" type="text/css" href="https://store.rencara.com/ct/css/zoom.css">
    ...
    <div class="slide-1 home-slider">
        <div>
            <div class="home  text-center">
                <img src="https://store.rencara.com/ct/img/yell3.jpg" alt="" class="bg-img blur-up lazyload">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <div class="slider-contain">
                                <div>
                                    <h4 style="color:white;">welcome to Rencara</h4>
                                    <h1 style="color:white;">Find u need</h1>
        ...
        <div>
            <div class="home text-center">
                <img src="https://store.rencara.com/ct/img/yell2.jpg" alt="" class="bg-img blur-up lazyload">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <div class="slider-contain">
...
<div class="title1 section-t-space">
    <h4>special offer</h4>
    <h2 class="title-inner1">New arrival</h2>
</div>
<div class="container">
    <div class="row">
        <div class="col-lg-6 offset-lg-3">
            <div class="product-para">
                <p class="text-center">Top updated item on database , with best price</p>
    ...
    <div class="container">
        <div class="row">
            <div class="col">
				...
				<?php $no = 1;foreach($i1 as $e){ ?>
				
                    <div class="product-box">
                        <div class="img-wrapper">
                            <div class="front">
                                <img style="height:250px;width:300px;"src="https://store.rencara.com/ct/img/<?php echo $e->imgi ?>" class="img-fluid blur-up lazyload " alt="">
                            </div>
							<div style="background-color:white;width:300px; height:250px;" class="back">
                                            <form action="<?php echo base_url('hp/input'); ?>" method="post">
													...
													<input style="display:none;" type="text" name="id" value="<?php echo $e->idi ?>">
													<input style="display:none;" type="text" name="idit" value="<?php echo $e->idit ?>">
													<input style="display:none;" type="text" name="vendor" value="<?php echo $e->n_vendor ?>">
													<input style="display:none;" type="text" name="name" value="<?php echo $e->n_item ?>">
													<input style="display:none;" type="text" name="price" value="<?php echo $e->price ?>">
													<input style="display:none;" type="text" name="payable" value="no">
													<input style="display:none;" type="text" name="midtrans_id" value="1">
													</br>
													<p class="btn btn-warning">Quantity : </p><input class="form-control-sm col-3" type="number" value="1" name="quantity" min="1" max="20" required>
													
													</br>
													<button type="submit" class="btn btn-warning">add to cart</button>
										</form></br>
													<button type="button" data-toggle="modal" data-target="#<?php echo $e->idi ?>" class="btn btn-warning">Detail</button>
										</div>
                        </div>
                        <div class="product-detail">
                            <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i></div>
                            <a href="#" data-toggle="modal" data-target="#<?php echo $e->idi ?>">
                                <h6><?php echo $e->n_item ?></h6>
                            </a>
                            <h4>Rp.<?php $price = number_format("$e->price", 2, ",", "."); echo $price ?></h4>
                        </div>
                    </div>
					<?php } ?>
                </div>
...
<div class="title1 section-t-space">
     <h4></h4>
	 <h2 class="title-inner1">ALL product</h2>
</div>
<section class="section-b-space p-t-0 ratio_asos">
    <div class="container">
        <div class="row">
                ...
                <div class="theme-tab">
                    ...
                    <div class="tab-content-cls">
                        <div id="tab-4" class="tab-content active default">
							...
							<?php $no = 1;foreach($i1 as $f){ ?>
                                <div class="product-box">
                                    <div class="img-wrapper">
                                        <div class="front">
                                            <img style="width:300px; height:250px;" src="https://store.rencara.com/ct/img/<?php echo $f->imgi ?>" class="img-fluid blur-up lazyload " alt="">
                                        </div>
                                        <div style="background-color:white;width:300px; height:250px;" class="back">
                                            <form action="<?php echo base_url('hp/input'); ?>" method="post">
													<input style="display:none;" type="text" name="customer" value="<?php echo $this->session->userdata("nama"); ?>">
													...
													<p class="btn btn-warning">Quantity : </p>
													<input class="form-control-sm col-2" type="number" value="1" name="quantity" min="1" max="20" required></br>
													<button type="submit" class="btn btn-warning">add to cart</button>
										</form></br>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
			...
			<div class="row">
			<div class="col-sm">
				<img style="width:80%;" class="zoom-it"  src="http://store.rencara.com/ct/img/<?php echo $f->imgi ?>" alt="">
            <p></p>
			</div>
			<div class="col-sm">
				...
				<input style="display:none;" type="text" name="payable" value="no">
				<input style="display:none;" type="text" name="midtrans_id" value="1">
				<p>Quantity : </p><input class="form-control-sm col-4" type="number" value="1" name="quantity" min="1" max="20" required></br>
...
<script src="https://store.rencara.com/ct/js/zoom.js"></script>
<!-- Theme js-->
