    ...
    <div class="container">
        <div class="row">
            <div class="col">
				...
				<?php $no = 1;foreach($cust as $e){ ?>
				
                    <div class="product-box">
                        <div class="img-wrapper">
                            <div class="front">
                                <img style="height:250px;width:250px;"src="https://store.rencara.com/ct/img/<?php echo $e->imgi ?>" class="img-fluid blur-up lazyload" alt="">
                            </div>
							<div style="background-color:white;height:250px;width:250px;"class="back">
                                            <form action="<?php echo base_url('cust/input'); ?>" method="post">
													...
													<p class="btn btn-warning">Quantity : </p><input class="form-control-sm col-4"type="number" value="1" name="quantity" min="1" max="20" required></br>
...
<section class="section-b-space p-t-0 ratio_asos">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
			...
			<div class="row">
			<div class="col-sm">
				<img style="width:80%;" src="http://store.rencara.com/ct/img/<?php echo $f->imgi ?>" alt="">
            <p></p>
			</div>
			<div class="col-sm">
				<h4>Detail</h4>
...
<!-- Tab product end -->
<?php foreach($ucheck as $e){ ?>
  <p style="display:none;" id="it"><?php echo $e->n_cust ?></p>
  <?php } ?>
<script type="text/javascript">
           if (document.getElementById("it").innerHTML.length == 0) {
			window.location = "https://store.rencara.com/cust/uupdate";
			}
</script>
