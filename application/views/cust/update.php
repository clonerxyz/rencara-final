        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="theme-card">
                    <form class="theme-form" method="POST" action="<?php echo base_url('cust/uup'); ?>">
                        <div class="form-row">
                            <div class="col-md-6">
                                <label for="email">Your Name</label>
                                <input type="text" class="form-control" name="n_cust" id="fname" placeholder="Your Name" required="">
                            </div>
                            <div class="col-md-6">
                                <label for="review">Email</label>
                                <input type="email" class="form-control" name="contact" id="review" placeholder="bla@bla.com" required="">
                            </div>
							<div class="col-md-6">
                                <label for="review">Alamat</label>
                                <input type="text" class="form-control" name="alamat" id="review" placeholder="Jl.blabla" required="">
                            </div>
							<div class="col-md-6">
                                <label for="review">Phone</label>
                                <input class="form-control" type="number" name="phone" id="review" placeholder="+62xxxxxx" required="">
                            </div>
